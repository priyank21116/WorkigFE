      ...
      return (
            ...
            <View style={tw`h-full  bg-indigo-500 w-full`}>
                  ...
                  <View style={[tw`h-3/6 items-center justify-center  w-full`, { backgroundColor: "#8f00ff" }]}>
                        ...
                        <View style={[tw`h-12 w-12 border rounded-full absolute items-center overflow-hidden bg-red-400 justify-center left-6 top-10`,{elevation:3,zIndex:3}]}>
...
<RenderMap />
                  ...
                  <ScrollView style={tw`h-3/6 bg-gray-100 w-full border-t-8  rounded-t-3xl   z-0`}>
                        <View>
                              <View>
